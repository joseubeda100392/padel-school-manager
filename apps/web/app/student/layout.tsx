  ...
  try {
      ...
      if (termsError) {
        return (
          <div className="p-8 font-mono text-red-600">
            <strong>[DEBUG LAYOUT — terms query error]</strong><br />
            code: {termsError.code}<br />
            message: {termsError.message}<br />
            details: {termsError.details}<br />
          </div>
        )
      }
    ...
    return (
      <div className="p-8 font-mono text-sm text-red-600 whitespace-pre-wrap">
        <strong>[DEBUG LAYOUT — excepción no capturada]</strong>{'\n'}
        {String(err)}{'\n'}
