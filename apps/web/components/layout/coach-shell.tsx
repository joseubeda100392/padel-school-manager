...
import { Home, Calendar, CalendarRange, BookOpen, MessageCircle, LogOut, Menu, X, Receipt, Repeat, HelpCircle } from 'lucide-react'
...
const allNavItems = [
  ...
  { href: '/coach/ayuda', label: 'Ayuda', icon: HelpCircle, exact: false, feature: null },
]
