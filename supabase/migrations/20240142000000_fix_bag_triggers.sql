...
ALTER TABLE class_bag DROP CONSTRAINT IF EXISTS chk_balance_60_non_negative;
ALTER TABLE class_bag DROP CONSTRAINT IF EXISTS chk_balance_90_non_negative;
ALTER TABLE class_bag ADD CONSTRAINT chk_balance_60_non_negative CHECK (balance_60 >= 0);
ALTER TABLE class_bag ADD CONSTRAINT chk_balance_90_non_negative CHECK (balance_90 >= 0);
